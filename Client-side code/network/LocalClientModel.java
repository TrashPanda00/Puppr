...
/**
 * LocalClientModel defines a collection of methods mirroring the LocalModel methods, used to send the information further to the RemoteModel
 * which communicates with the server.
 * The interface extends LocalSubject with Object as the two parameters making the methods able to notify LocalClientModel listeners
 *
 * @author Natali Munk-Jakobsen
 * @version 1.0
 */
public interface LocalClientModel extends LocalSubject<Object, Object>
{
  /**
